...
public class MainController extends HttpServlet {
    ...
    private static final String ADD_TO_CART_CONTROLLER = "AddController";
    ...
    private static final String ITL = "ItemsList";
    private static final String ITEMSLIST_CONTROLLER = "itemsList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else if (ITL.equals(action)) {
                url = ITEMSLIST_CONTROLLER;
            } else {
